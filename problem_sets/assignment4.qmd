...
Answer: I think the most informative plots are the ones using facet_wrap, where the variables are visually broken out. The density plot also provides a really nice visual. There is certainly variability in the data, and I'd expect there to be some statistically significant differences.
